...
describe(NAME, function () {
    ...
    describe("exploit", async function () {
        ...
        it("conduct your attack here", async function () {
            ...
            const Attacker = await ethers.getContractFactory("DiamondHandsAttacked");
            const attackercontract = await Attacker.deploy(diamondcontract.address, chickencontract.address);
            await attackercontract.deployed();
            await chickencontract.connect(attackerWallet).FryChicken(attackercontract.address, 20);
